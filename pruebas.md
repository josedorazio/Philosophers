...
🔹 Caso 1.1 — Filósofos deben comer indefinidamente ./philo 2 800 200 200  ----> FUNCIONA ✅
...
🔹 Caso 1.2 — Uno debe morir por inanición ./philo 2 310 200 200 ----> FUNCIONA ✅
...
🔹 Caso 2.1 — Todos deben comer exactamente 7 veces ./philo 5 800 200 200 7 --- FUNCIONA ✅
...
🔹 Caso 2.2 — Todos comen más de 7 veces (ok) ./philo 5 1000 50 50 7 --- FUNCIONA ✅
...
🔹 Caso 2- 3 — Alguno muere antes de alcanzar meals_required ./philo 5 300 200  200 7 --- FUNCIONA ✅
...
🔹 Caso 3.1 — 1 filósofo (caso límite) ./philo 1 800 200 200  --- FUNCIONA ✅
...
🔹 Caso 3.2 — Máxima contención ./philo 199 800 200 200  FUNCIONA ✅
...
🔹 Caso 4.1 — Tiempos muy cortos (riesgo de desincronización) ./philo 4 60 20 20 FUNCIONA ✅
- sperado:
- - osible muerte rápida por no comer a tiempo.
- Muestra si el sistema gestiona correctamente sleeps precisos.

🔹 Caso 4.2 — Tiempos muy largos (más difícil que mueran) ./philo 4 10000 300 300 FUNCIONA ✅
...
🔹 Caso 5.1 — Verifica que no se imprimen cosas después de una muerte ./philo 3 310 200 200  FUNCIONA ✅

Esperado- 
- Se impri- e solo un "died. RIP".
- Después de- eso, ninguna línea más debe aparecer.

🔹 Caso 5.2 — Salida limpia después de "All philosophers ate enough" ./philo 3 1000 100 100 5 ./philo 3 1000 100 100 5
...
7. ./philo 5 800 200 200  NO FUNCIONA
- No philosopher should die.

8. ./philo 5 800 200 200 7 FUNCIONA
- No philosopher should die and the simulation should stop when every philosopher has eaten at least 7 times

9. ./philo 4 410 200 200 NO FUNCIONA
- No philosopher should die

10. ./philo 4 310 200 100 FUNCIONA 
- One philosopher should die


COMANDOS CON LOS QUE NO EFECTUA LO QUE SE ESPERA
./philo 5 800 200 200
./philo 4 410 200 200